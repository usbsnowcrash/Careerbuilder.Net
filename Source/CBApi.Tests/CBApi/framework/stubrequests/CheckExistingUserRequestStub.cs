...
namespace Tests.CBApi.models.requests {
    internal class CheckExistingUserRequestStub : CheckExistingUserRequest {

        public CheckExistingUserRequestStub(string key, string domain, string cobrand, string siteid, int timeout)
